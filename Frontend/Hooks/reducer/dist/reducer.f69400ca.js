...
var actions = {
  ...
  incrementA: function incrementA(s) {
    return {
      a: s.a + 1
    };
  },
  reset: function reset(s) {
    return {
      a: 0,
      b: 0
    };
...
var App = function App() {
  var _a = react_1.useReducer(function (s, action) {
  ...
  return react_1.default.createElement("div", null, "a=", state.a, ", b=", state.b, react_1.default.createElement("br", null), react_1.default.createElement("button", {
    onClick: function onClick() {
      return dispatch("reset");
    }
  }, "Reset"), react_1.default.createElement("button", {
    onClick: function onClick() {
      return dispatch("incrementA");
    }
  }, "Incr A"));
};

react_dom_1.render(react_1.default.createElement(App, null), document.getElementById("root"));
},{"react-dom":"node_modules/react-dom/index.js","react":"node_modules/react/index.js"}],"../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "42065" + '/');
...
//# sourceMappingURL=/reducer.f69400ca.js.map